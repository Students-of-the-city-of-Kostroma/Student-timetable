namespace TimetableOfClasses
{
    partial class Start
    {
        ...
        private void InitializeComponent()
        {
			...
			this.институтыПодготовкиToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.институтыПодготовкиToolStripMenuItem});
      ...
      // корпусаToolStripMenuItem
			...
			// 
			// институтыПодготовкиToolStripMenuItem
			// 
			this.институтыПодготовкиToolStripMenuItem.Name = "институтыПодготовкиToolStripMenuItem";
			this.институтыПодготовкиToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			this.институтыПодготовкиToolStripMenuItem.Text = "Институты подготовки";
			this.институтыПодготовкиToolStripMenuItem.Click += new System.EventHandler(this.институтыПодготовкиToolStripMenuItem_Click);
			// видыЗанятийПодготовкиToolStripMenuItem
			// 
			this.видыЗанятийПодготовкиToolStripMenuItem.Name = "видыЗанятийПодготовкиToolStripMenuItem";
			this.видыЗанятийПодготовкиToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
		...
		private System.Windows.Forms.ToolStripMenuItem институтыПодготовкиToolStripMenuItem;
