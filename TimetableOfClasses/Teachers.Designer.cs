namespace TimetableOfClasses
{
	partial class Teachers
	{
		...
		private void InitializeComponent()
		{
			...
			this.FullName.FillWeight = 95.63451F;
			...
			this.AcademicDegree.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			// 
			// Departament
			// 
			this.Departament.DataPropertyName = "Departament";
			this.Departament.FillWeight = 95.63451F;
			...
			this.MetodicalDays.FillWeight = 95.63451F;
			...
			this.Windows.FillWeight = 95.63451F;
			...
			this.Weekends.FillWeight = 95.63451F;
