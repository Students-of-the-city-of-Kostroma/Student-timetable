...
- Студент реализует задачу в ветку и запрашывает запрос на слияние. При это имя запрос должно соответсвовать шаблону "WIP: ИмяЗадачиДляКоторойВыполняетсяЗапрос",Ю  а описание должно содержать текст "Закрывает #123"
