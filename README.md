...
## Задачи с меткой Story, Auto Test, Bug, Improvement:
...
- Ни на кого не назначенные открытые задачи без меток состояния выполнения - эти задачи формируют список задач из которого участник проекта может взять на исполнение.
...
- Bug - задача на устранения несоответствия реальной функциональности и заявленной функциональности в Story. В баге всегда указывается Story для которой заводиться этот баг.
- Controller - (MVC) Задача на разработку кода реализующий логику ПО
- Model - (MVC) Задача на разработку кода организующий хранение данных
...
* Исчезновение вертикального скролла для таблицы Преподаватели
## Description
...
* Исчезновение вертикального скролла, при удалении отображаемых строк
