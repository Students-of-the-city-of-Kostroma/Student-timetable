...
- Bug - задача на устранения несоответствия реальной функциональности и заявленной функциональности в Story. В баге всегда указывается Story для которой заводится этот баг.
...
## Test Data
(необязательный) может содержать SQL запросы, перечень объектов которые потребуются для тестирования и т.д.
## Steps
