...
- Ни на кого неназначеные открытые задачи без меток состояния выполнения - эти задачи формируют список задач из которого участник проекта может взять на исполнение.
