...
|R2|1245_1|Изменить сведения в пустой таблице| Входных данных нет | Rows.count = "0" Discipline = "Валидные данные"; Distributed = "Валидные данные"; Occupation = "Валидные данные"; Teacher = "Валидные данные"; TotalHours = "Валидные данные"|недостижим//Входные данные не могут быть пусты |
|R3|1245_2|Изменить несуществующую группу в заполненной таблице|group = "17-ИСбо-2а", totalHours =  "100", Discipline = "Правоведение", teacher =  "Иванов Иван Иванович", occupation =  "Лекция", distributed = "20"|Rows.count == 1, но Rows[i]["Group"] != mAcademic.Group Discipline  = "17-исбо-4ф" Distributed = "Валидные данные"; Occupation = "Валидные данные"; Teacher = "Валидные данные"; TotalHours = "Валидные данные"|true|
