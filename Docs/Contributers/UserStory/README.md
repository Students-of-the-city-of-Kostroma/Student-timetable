...
* В конечной папке должен находиться отчёт с следующим названием:

**README.md**

* Также в конечной папке должны находиться изображения, представленные по следующему шаблону:

**"Порядковый номер изображения".png**
