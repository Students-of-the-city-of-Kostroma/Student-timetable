...
Пользовательсякая история представляет из себя текстовый файл с именем `READMY.md`. Файлы располанается в дирректории `/Docs/Technical/UserStories/Story-100`, пример относительного пути к файлу `/Docs/Technical/UserStories/Story-100/READMY.md`, где 100 это порядковый номер пользовательской истории.
