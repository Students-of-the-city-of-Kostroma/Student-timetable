...
На этапе анализа требований жизненного цикла ПО данная методология является прекрасным решением, понятное как разработчикам, так и заказчику. 
...
После создания User Story **ОБЯЗАТЕЛЬНО** нужно внести изменения в техническое задание.
...
Возникает много вопросов как по продукту, так и по процессу, решение которых совместно со всей командой, менеджерами, заказчиками, и т.д, есть не что иное как встраивание качества в продукт на самых ранних этапах его развития. Для этого нам нужен будет тест-план, в который нужно будет внести новую пользовательскую историю для тестирования, по которой впоследствии будут составлены функциональные тесты.
