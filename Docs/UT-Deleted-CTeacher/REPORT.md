...
| R2 | task-1281-2 | Удаление несуществующего преподавателя | FirstName = "Чередникова", SecondName = "Алла",  Patronymic = "Викторовна" | FirstName - Невалидные данные, SecondName - Невалидные данные, FullName - Невалидные данные, Departament - Невалидные данные | false |
...
| R4 | task-1281-4 | Некорректное удаление преподавателя |  FirstName = "Прядкина", SecondName = "Нина",  Patronymic = "Олеговна" | FirstName - Невалидные данные, SecondName - Невалидные данные, FullName - Невалидные данные, Departament - Невалидные данные | false |                     
