...
| --- | --- | --- | --- | --- | --- |
| task-1281-1 | R1 | Удаление сведений в пустой таблице | Таблица преподавателей пуста | FirstName - Валидные данные, SecondName - Валидные данные, FullName - Валидные данные, Departament - Валидные данные | false |
