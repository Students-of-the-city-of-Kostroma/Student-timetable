...
|R4|247_4|Ввод корректных данных, при условии, что вводимое ученое звание преподавателя не существует|AcademicDegree = "КН"; AcademicTitle = "Доц"; MetodicalDays = "Пн, Вт";  Windows = "Ср, Чт, Пт" Weekends = "Вс"|AcademicDegree = "КН"; AcademicTitle = "П"; MetodicalDays = "Пн, Вт";  Windows = "Ср, Чт, Пт" Weekends = "Вс"|false|
