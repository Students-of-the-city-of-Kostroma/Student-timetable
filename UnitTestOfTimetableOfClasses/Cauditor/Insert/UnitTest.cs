...
namespace UnitTestOfTimetableOfClasses.UT_CAuditor.ForFix
{
    [TestClass]
    public class UT_ICAuditor
    {
        ...
        [TestMethod]
        public void UT_ICAuditor_6() //добавление записи ктороая не дублирует ни один атрибут уже имеющейся записи 
        {
            //arrange
            MAuditor aud = new MAuditor("502", "каф. Иностранных языков", 20, "5");
            CAuditor ca = new CAuditor();
        ...
        [TestMethod]
        public void UT_ICAuditor_7() //полное дублирование всех атрибутов
        {
            //arrange
            MAuditor aud = new MAuditor("502", "каф. Иностранных языков", 20, "5");
            CAuditor ca = new CAuditor();
        ...
        [TestMethod]
        public void UT_ICAuditor_2() // дбавление записи, которая не дублирует ни один атрибут кроме корпуса
        {
            //arrange
            MAuditor aud = new MAuditor("502", "каф. Иностранных языков", 20, "5");
            CAuditor ca = new CAuditor();
        ...
        [TestMethod]
        public void UT_ICAuditor_3() // дбавление записи, которая не дублирует ни один атрибут кроме кафедры
        {
            //arrange
            MAuditor aud = new MAuditor("502", "каф. Иностранных языков", 20, "5");
            CAuditor ca = new CAuditor();
        ...
        [TestMethod]
        public void UT_ICAuditor_4() // дбавление записи, которая не дублирует ни один атрибут кроме числа мест
        {
            //arrange
            MAuditor aud = new MAuditor("502", "каф. Иностранных языков", 20, "5");
            CAuditor ca = new CAuditor();
