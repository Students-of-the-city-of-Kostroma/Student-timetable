...
namespace UnitTestOfTimetableOfClasses
{
	...
	public class UT_Delete_CDirectionOfPreparation
	{
		public void Pre_condition_Del()
		{
			...
			int C1 = Controllers.CDirectionOfPreparation.Rows.Count;
			act = Controllers.CDirectionOfPreparation.Insert(T_DirectionOfPreparation);
			int C2 = Controllers.CDirectionOfPreparation.Rows.Count;
		...
		public void Task_555_1()
		{
			...
			int C1 = Controllers.CDirectionOfPreparation.Rows.Count;
			act = Controllers.CDirectionOfPreparation.Delete(T_DirectionOfPreparation);
			int C2 = Controllers.CDirectionOfPreparation.Rows.Count;
			Assert.AreEqual(ex, act);
			Assert.AreEqual(C1 - 1, C2);
		}
