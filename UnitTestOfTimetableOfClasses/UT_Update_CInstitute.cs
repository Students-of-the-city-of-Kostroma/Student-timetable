...
namespace UnitTestOfTimetableOfClasses
{
	...
	public class UT_Update_CInstitute
	{
		...
		public void Task_513_1() //замена всех атрибутов	
		{
			...
			MInstitute i = new MInstitute("Институт Автоматизированных систем и технологий", "ИАСТ", "Лустгартен Ю.Л.", "КГУ");
			MInstitute i1 = new MInstitute("Факультет Автоматизированных систем и технологий", "ФАСТ", "Голубева Ю.А.", "КГТУ");
