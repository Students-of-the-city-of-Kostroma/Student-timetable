...
namespace UnitTestOfTimetableOfClasses.UT_CInstitute.UT_Insert
{
    ...
    public class UT_ICInstitute
    {
        ...
        [TestMethod]
        public void UT_ICInstitute_1() //Добавление в пустую таблицу    
        {
            //arrange     
        ...
        [TestMethod]
        public void UT_ICInstitute_2() //краткое название дублируется
        {
            bool ex = false;
            bool act;
        ...
        [TestMethod]
        public void UT_ICInstitute_3() // полное название дублируется
        {
            bool ex = false;
            bool act;
        ...
        [TestMethod]
        public void UT_ICInstitute_4() // директор дублируется
        {
            bool ex = false;
            bool act;
        ...
        [TestMethod]
        public void UT_ICInstitute_5() // наименование ВУЗа дублируется
        {
            bool ex = false;
            bool act;
