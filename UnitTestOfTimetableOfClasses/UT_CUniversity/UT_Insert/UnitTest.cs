...
namespace UnitTestOfTimetableOfClasses.UT_CUniversity.UT_Insert
{
    ...
    public class UT_ICUniversity
    {
        ...
        /// </summary>
        [TestMethod]
        public void UT_ICUniversity_10()
        {
            // arrange
